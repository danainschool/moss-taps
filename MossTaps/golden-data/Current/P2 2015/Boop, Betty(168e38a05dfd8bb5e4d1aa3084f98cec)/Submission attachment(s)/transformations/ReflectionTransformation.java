...
public class ReflectionTransformation implements Transformation {
    ...
    public String toString() {
        return "RFL[" + (acrossHorizontal ? "HRZ" : "VRT") + "]";
    }
    ...
    public boolean equals(final Object o) {
        ...
        ReflectionTransformation that = (ReflectionTransformation) o;
        return acrossHorizontal == that.acrossHorizontal;
    }

    @Override
    public int hashCode() {
        return Boolean.hashCode(acrossHorizontal);
    }
}
