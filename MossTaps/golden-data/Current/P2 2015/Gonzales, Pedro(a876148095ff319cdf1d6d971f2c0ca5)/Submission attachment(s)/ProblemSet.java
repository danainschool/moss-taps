...
public class ProblemSet {
    ...
    private void loadProblemSet() {
        Scanner r = null;
        try {
            r = new Scanner(new File("res" + File.separator + "Problems" + File.separator + getName() + File.separator + "ProblemList.txt"));
        } catch(Exception ex) {
    ...
    private void loadProblem(String problemName) {
        Scanner r = null;
        try {
            r = new Scanner(new File("res" + File.separator + "Problems" + File.separator + getName() + File.separator + problemName + File.separator + "ProblemData.txt"));
        } catch(Exception ex) {
            System.out.println(ex);
        }
