...
public class TransitionFactory {
    ...
    public static Transition getTransition(TransitionType type, RavensObject initial, RavensObject current) {
        ...
        switch(type) {
            ...
            case EXPANDED_W:
            case EXPANDED_H:
                String iniE = t.getTransitionType() == TransitionType.EXPANDED_H ? initialAttr.get("height") : initialAttr.get("width");
                String currentE = t.getTransitionType() == TransitionType.EXPANDED_H ? currentAttr.get("height") : currentAttr.get("width");
                if(iniE == null){
                    t.setValue("grow");
                    break;
                }
                ...
                if(iniE.equalsIgnoreCase("very small")){
                    t.setValue("grow");
                }
                else if(iniE.equalsIgnoreCase("small")){
                    switch(currentE.toLowerCase()){
                        case "very small":
                            t.setValue("shrink");
                            break;
                        default:
                ...
                else if(iniE.equalsIgnoreCase("medium")){
                    switch(currentE.toLowerCase()) {
                        case "very small":
                        case "small":
                            t.setValue("shrink");
                ...
                else if(iniE.equalsIgnoreCase("large")){
                    switch(currentE.toLowerCase()) {
                        case "very small":
                        case "small":
                        case "medium":
                ...
                else if(iniE.equalsIgnoreCase("very large")){
                    switch(currentE.toLowerCase()){
                        case "huge":
                            t.setValue("grow");
                            break;
