...
public class ProductionSystem {
	...
	private static boolean isRavenObjectsEqual(HashMap<String, RavensObject> objA, HashMap<String, RavensObject> objB) {
		...
		for (Map.Entry<String, RavensObject> entry : objA.entrySet()) {
			RavensObject currentObject = entry.getValue();
			String attributes = currentObject.getAttributes().toString();
			attributesA += attributes;
			// System.out.println(attributes);
		}
		for (Map.Entry<String, RavensObject> entry : objB.entrySet()) {
			RavensObject currentObject = entry.getValue();
			String attributes = currentObject.getAttributes().toString();
