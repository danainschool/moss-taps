...
public class TransformList {
	...
	// TODO: Implement
	public TransformList(String diffString) {

		// separate string by semicolons
		String[] temp = diffString.split(";");
	}
	...
	public int GetDifferenceScore() {
		...
		for (Transform t : mList)
		{
			...
			else if ((t.mAttribute.equals("inside")) || (t.mAttribute.equals("above")))
			{
				// do nothing
			}
			else
