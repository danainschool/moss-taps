...
public class CNstart {
    public static void main(String[] args) throws Exception {
        // a list of students' source code files located in the prepared
        // directory.
        Collection<File> files = FileUtils.listFiles(new File(
//        	"C:/Users/Dana/Documents/GitHub/MOSS-TAPS/MossTaps/data/Python_Students"), new String[] { "py" }, true);
    		"C:/Users/Dana/Desktop/bulk_download/P3"), new String[] { "py" }, true);
        showFiles(files);

        // a list of base files that was given to the students for this
        // assignment.
        Collection<File> baseFiles = FileUtils.listFiles(new File(
    		"C:/Users/Dana/Documents/GitHub/MOSS-TAPS/MossTaps/data/base_directory"), new String[] { "py" }, true);
        showFiles(baseFiles);
